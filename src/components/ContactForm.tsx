    ...
    <section id="contacto" className="py-32 bg-gradient-to-b from-surface-container-lowest to-surface">
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-8 text-primary">
            ¿Listo para destacar?
          </h2>

          {/* WhatsApp Priority Banner */}
          <a
            href="https://wa.me/34620049872?text=HOLA%20ROTULOS%20PATERNA"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex flex-col sm:flex-row items-center gap-4 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-3xl px-8 py-6 shadow-2xl hover:shadow-green-500/30 transition-all hover:-translate-y-0.5 max-w-lg mx-auto"
          >
            ...
            <div className="text-left">
              <p className="font-montserrat text-lg font-bold">¿Prefieres WhatsApp?</p>
              <p className="font-inter text-sm text-white/90">
                Respondemos más rápido por aquí. Toca para hablarnos directamente.
              </p>
            </div>
            <span className="material-symbols-outlined text-2xl flex-shrink-0">arrow_forward</span>
          </a>
        </div>
