...
const paternaServices = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1580121449976-4a10f5b2c4dd?w=800&q=80",
  ...
  },
  {
    ...
    icon: "text_fields",
    image:
      "https://images.unsplash.com/photo-1568821232505-9aa5c8a554ab?w=800&q=80",
      ...
      >
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-primary via-surface-dim to-surface-container rounded-3xl p-10 md:p-14 shadow-2xl">
            ...
            <p className="font-inter text-base md:text-lg text-white/90 max-w-xl mx-auto mb-8">
